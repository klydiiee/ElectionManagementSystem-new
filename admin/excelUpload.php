...
if(isset($_POST['Submit'])){
  ...
  if(in_array($_FILES["file"]["type"],$mimes)){
    ...
    $html="<table border='1'>";
    $html.="<tr><th>Student ID</th><th>Last Name</th><th>First Name</th><th>Year level</th><th>Department</th><th>Email</th></tr>";
    ...
    for($i=0;$i<$totalSheet;$i++){
      ...
      foreach ($Reader as $Row)
      {
        ...
        $mysqli->query($query);
         ...
         $query = "insert into user(student_id,email,password) values('".$student_id."','".$email."','".$student_id."')";
        $mysqli->query($query);
      }
