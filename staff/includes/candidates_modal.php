            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    <label for="voter" class="col-sm-3 control-label">Voters ID</label>

                    <div class="col-sm-9">
                      
                      <select class="form-control" id="voter" name="voter" required>
                        ...
                        <?php
                          ...
                          while($row = $query->fetch_assoc()){
                            echo "
                              <option value='".$row['id']."'>".$row['voters_id']."</option>
                            ";
                          }
                        ?>
                      </select>
